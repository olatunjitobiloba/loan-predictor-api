...
swagger_template = {
    ...
    "info": {
        ...
        "description": (
            "AI-powered loan approval prediction system with 88.62% accuracy. "
    ...
    "tags": [
        ...
        {"name": "Prediction", "description": "Loan prediction endpoints"},
        {"name": "History", "description": "Prediction history endpoints"},
        {"name": "Statistics", "description": "Analytics and statistics endpoints"},
        {"name": "Information", "description": "API and model information"},
    ],
    "securityDefinitions": {},
    "security": [],
}
