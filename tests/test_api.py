...
class TESTAPIEndpoints:
    ...
    def test_home_endpoint(self, client):
        ...
        assert data['name'] == 'Loan Predictor API'
...
class TestPredictionEndpoint:
    ...
    def test_predict_minimal_valid_data(self, client):
        ...
        response = client.post('/predict', data=json.dumps(minimal_data),
                               content_type='application/json')
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data['success'] == True
    ...
    def test_predict_stores_in_database(self, client,
valid_prediction_data):
        ...
        with app.app_context():
            ...
            assert prediction.applicant_income == valid_prediction_data['ApplicantIncome']
...
class TestHistoryEndpoints:
    ...
    def test_history_with_predictions(self, client,
valid_prediction_data):
    ...
    def test_get_specific_prediction(self, client,
valid_prediction_data):
