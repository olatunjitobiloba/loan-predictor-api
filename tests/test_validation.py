...
def test_minimal_valid_data():
    ...
    validation_case("Minimal valid Data", {"ApplicantIncome": 5000}, 200)


def test_missing_required_field():
    """Test 3: Missing required field"""
    validation_case("Missing Required Field", {"LoanAmount": 150}, 400)


def test_invalid_data_type():
    """Test 4: Invalid data type"""
    validation_case("Invalid Data Type", {"ApplicantIncome": "not a number"}, 400)


def test_negative_income():
    """Test 5: Negative income"""
    validation_case("Negative Income", {"ApplicantIncome": -5000}, 400)


def test_income_out_of_range():
    """Test 6: Income too high"""
    validation_case("Income Out of Range", {"ApplicantIncome": 200000}, 400)


def test_invalid_gender():
    """Test 7: Invalid gender"""
    validation_case("Invalid Gender", {"ApplicantIncome": 5000, "Gender": "Other"}, 400)


def test_invalid_education():
    """Test 8: Invalid education"""
    validation_case(
        "Invalid Education", {"ApplicantIncome": 5000, "Education": "PhD"}, 400
    )
...
def test_valid_with_warnings():
    ...
    validation_case(
        "Valid with Warnings",
        {"ApplicantIncome": 800, "LoanAmount": 300, "Credit_History": 0},
        200,
    )
...
def test_high_loan_to_income_ratio():
    ...
    validation_case(
        "High Loan-to-Income Ratio", {"ApplicantIncome": 2000, "LoanAmount": 500}, 200
    )
...
def test_multiple_validation_errors():
    ...
    validation_case(
        ...
        {"ApplicantIncome": -1000, "Gender": "Unknown", "LoanAmount": 50000},
        400,
    )
