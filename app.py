...
def api_info():
    return jsonify(
        {"message": "Loan Predictor API", "version": "1.0", "status": "running"}
    )
            ...
            jsonify(
                {
                    ...
                    "example": {"age": 35, "income": 50000, "loan_amount": 20000},
                }
            ),
            400,
        )
            ...
            jsonify(
                {
                    ...
                    "message": "The following required fields are missing: " + msg,
                }
            ),
            400,
        )
...
def search():
    ...
    )  # Default value and type conversion
...
def loan_handler():
    ...
    if method == "GET":
        ...
        loan_id = request.args.get("id")
        return jsonify(
            {"method": "PUT", "loan_id": loan_id, "data": data, "action": "update"}
        )
